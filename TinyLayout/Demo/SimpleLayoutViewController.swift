...
//            }
            ...
            blackView.ty.makeConstraints { view, superView in
...
//            }
            ...
            redView.ty.makeConstraints { view, superView in
                view.top == blackView.bottom + 20
                view.right == blackView.left - 20
                view.width == 100
                view.height == 100
            }
...
//            }
            ...
            yellowView.ty.makeConstraints { view, superView in
                view.top == blackView.bottom + 20
                view.left == blackView.right + 20
                view.width == 100
                view.height == 100
            }
...
//            }
            ...
            blueView.ty.makeConstraints { view, superView in
                view.bottom == blackView.top - 20
                view.left == blackView.right + 20
                view.width == 100
                view.height == 100
            }
...
//            }
            ...
            greenView.ty.makeConstraints { view, superView in
                view.bottom == blackView.top - 20
                view.right == blackView.left - 20
                view.height == 100
                view.width == 100
